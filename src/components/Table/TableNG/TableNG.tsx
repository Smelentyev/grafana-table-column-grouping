...
import { useStyles2, useTheme2, Pagination, usePanelContext, type PanelContext } from '@grafana/ui';
import { DataLinksActionsTooltip } from '../DataLinksActionsTooltip';
import { TableCellInspector, TableCellInspectorMode } from '../TableCellInspector';
import { TableCellDisplayMode } from '../types';
import { DataLinksActionsTooltipState } from '../utils';
import { TableWithGroupedHeaders } from './TableWithGroupedHeaders';
...
export function TableNG(props: TableNGProps) {
  ...
  // If column grouping is enabled, use the specialized component
  if (columnGrouping?.enabled) {
    return <TableWithGroupedHeaders {...props} columnGrouping={columnGrouping} />;
  }
