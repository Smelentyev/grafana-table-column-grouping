...
/* ---------------------------- Header Grouping Types ---------------------------- */

/**
 * Orientation for column grouping (vertical or horizontal layout)
 */
export type Orientation = 'vertical' | 'horizontal';

/**
 * Root group item - represents a main group with a data field and orientation
 */
export interface RootGroupItem {
  id: string; // Unique identifier for editor
  type: 'root-group';
  column: string; // Name of the field for this group
  orientation: Orientation;
  children: GroupChild[];
}

/**
 * Group container item - container for organizing structure (no data field)
 */
...
/**
 * Column item - leaf node representing a data column
 */
export interface ColumnItem {
  id: string; // Unique identifier for editor
  type: 'column';
  column: string; // Name of the field
}

/**
 * Union type for all possible group children
 */
export type GroupChild = RootGroupItem | GroupContainerItem | ColumnItem;

/**
 * Alias for GroupChild - used in editor for consistency with original code
 */
export type GroupItem = GroupChild;

/**
 * Column grouping settings for hierarchical header groups
 */
export interface ColumnGroupingSettings {
  enabled: boolean;
  ungroupedColumns: string[]; // Columns not in any group
  rootGroups: RootGroupItem[]; // Root level groups
}
